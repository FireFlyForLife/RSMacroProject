...
namespace RSMacroProgram
{
    public static class WinAPI
    {
        ...
        internal static extern uint SendInput(uint numberOfInputs, Win32.INPUT[] inputs, int sizeOfInputStructure);
    ...
    public class Win32
    {
        #region Input structs and enums
        /// <summary>
        ...
        public enum MouseCallbackMessages
        {
